...
public class TripService {
  //  private final SupplierConnection supplierConnection = SupplierConnection.getInstance();
    ...
    public void addNewTrip(String id_str, String name,String tripid, String triptype, String tripdate, int tripprice,String tripduration ,int profit,int No_pass) {
        ...
        if (id_str.isBlank() || tripid.isBlank()  || triptype.isBlank() || tripdate.isBlank()) {
            ...
            Trip trip = new Trip(Integer.parseInt(id_str),name,tripid ,triptype, tripdate,tripprice,tripduration,profit,No_pass);
...
public List<Trip> getTrips() {
       ...
       TripsList.add(new Trip (1234,"Nancy","F3245","Economy","2023-08-6",500,"25" ,500,3)) ;
       TripsList.add(new Trip (1234,"Nancy","F5346","Business","2023-07-24",1000,"50",1000,2));
       TripsList.add(new Trip (1234,"Nancy","F7645","First class","2023-08-9",2000,"30" ,2000,1)) ;
            
        
        TripsList.add(new Trip (5462,"Salma","F5342","Economy","2023-07-20",500,"12" ,500,5)) ;
        TripsList.add(new Trip (5462,"Salma","F9876","Business","2023-08-9",1000,"60" ,1000,2)) ;
       
        
        
         TripsList.add(new Trip (3095,"Alaa","F5637","Economy","2023-08-9",500,"30",500,6)) ;
         TripsList.add(new Trip (3095,"Alaa","F8712","First class","2023-08-30",2000,"83" ,2000,3)) ;
    ...
    public Trip getTrip(int id) {
        ...
        return new Trip (1234,"Nancy","F3245","Economy","2023-08-6",500,"25" ,500,3) ;
    }

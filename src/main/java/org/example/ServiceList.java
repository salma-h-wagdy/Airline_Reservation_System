...
public class ServiceList extends javax.swing.JFrame {
    ...
    Image img = Toolkit.getDefaultToolkit().getImage(this.getClass().getClassLoader().getResource("images/welcom.jpg"));
		...
		this.add(login_button);                                                
                ...
                JButton Client = new JButton("Client", new ImageIcon("src\\images\\client.jpg"));
                Client.setBounds(30, 120, 185, 180);
		Client.setFont(Service_font);
		Client.addActionListener(e -> handleClient());                         
		this.add(Client);                                                
                changeLookAndFeel();
